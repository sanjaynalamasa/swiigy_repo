...
//                 />
//                 <div className="res-offer">{resData.name}</div>
//             </div>
//             <div className="res-info">
//                 <h3 className="res-name">{resData.name}</h3>
//                 <div className="res-rating-time">
//                     <span className="res-rating">{resData.rating}</span>
//                     <span className="res-time">{}</span>
//                 </div>
//                 <p className="res-location">{resData.location}</p>
//                   <p className="res-cuisine">{resData.cuisine}</p>
//             </div>
//         </div>
//     );
// };
